...
public class ModFluids {
    ...
    public static final FluidObject<ForgeFlowingFluid> MOLTEN_ALUMITE = Registration.FLUIDS.register("molten_alumite", moltenBuilder().color(16765175).temperature(1200), Material.LAVA, 12);
